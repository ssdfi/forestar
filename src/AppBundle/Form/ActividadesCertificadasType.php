...
class ActividadesCertificadasType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        ->add('fechaInicio', DateType::class, array('label' => false,'widget'=>'single_text','format' => 'MM-yyyy','required'=>false,'attr' => array('class' => 'form-control','placeholder'=>"MM-AAAA",'pattern'=>'\d{2}-\d{4}', 'title'=>'El formato debe ser MM-AAAA')))
        ...
        ->add('densidadPrevia', NumberType::class, array('label'=>false,'required'=>false, 'attr'=> array('pattern'=>'^[-+]?\d+$', 'title'=>'Número entero')))
        ...
        ->add('turnoCorta', DateType::class, array('label' => false,'widget'=>'single_text','format' => 'yyyy','required'=>false,'attr' => array('class' => 'form-control','placeholder'=>"AAAA",'pattern'=>'\d{4}', 'title'=>'El formato debe ser AAAA')))
