 ...
 *
 * @ORM\Table(name="actividades_titulares", indexes={@ORM\Index(name="IDX_64F251EB4BF37E4E", columns={"expediente_id"}), @ORM\Index(name="IDX_64F251EBF9F0FF64", columns={"titular_id"}), @ORM\Index(name="IDX_64F251EB9C50892D", columns={"actividad_presentada_id"}), @ORM\Index(name="IDX_64F251EB93D6EF8E", columns={"actividad_certificada_id"}), @ORM\Index(name="IDX_64F251EB21AD3479", columns={"actividad_inspeccionada_id"}), @ORM\Index(name="IDX_64F251EB86D7A7A1", columns={"actividad_sig_id"}), @ORM\Index(name="IDX_64F251EBD49F6714", columns={"actividad_aprobada_id"}), @ORM\Index(name="IDX_64F251EBF3357478", columns={"entidad_agrupadora_id"}), @ORM\Index(name="IDX_64F251EB56CAD4EB", columns={"beneficios_solicitados_expedientes_id"}), @ORM\Index(name="IDX_64F251EB414B4C53", columns={"cobros_beneficios_id"}), @ORM\Index(name="IDX_64F251EBD1149A3", columns={"disposiciones_provinciales_id"}), @ORM\Index(name="IDX_64F251EB8D759A7D", columns={"documentos_legales_id"}), @ORM\Index(name="IDX_64F251EB657A4C89", columns={"documentacion_id"}), @ORM\Index(name="IDX_64F251EB2F00B781", columns={"historial_contable_id"}), @ORM\Index(name="IDX_64F251EB85737573", columns={"historial_foresto_industriales_id"}), @ORM\Index(name="IDX_64F251EBF6B80AA6", columns={"historial_legales_id"}), @ORM\Index(name="IDX_64F251EB87573826", columns={"historial_promocion_id"}), @ORM\Index(name="IDX_64F251EB9038BCEA", columns={"historial_sig_id"}), @ORM\Index(name="IDX_64F251EB430D1F7D", columns={"impacto_ambiental_id"}), @ORM\Index(name="IDX_64F251EBF8776DCA", columns={"predios_id"}), @ORM\Index(name="IDX_64F251EBB086BC0", columns={"registro_sig_id"}), @ORM\Index(name="IDX_64F251EB32339F34", columns={"resoluciones_id"}), @ORM\Index(name="IDX_64F251EB7708DF12", columns={"aux_actividades_id"})})
 * @ORM\Entity
 */
